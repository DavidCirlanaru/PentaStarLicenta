...
namespace PentaStarLicenta.Controllers
{
    public class RoomTypesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "RoomTypeId,Type,Price")] RoomType roomType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "RoomTypeId,Type,Price")] RoomType roomType)
        {
            if (ModelState.IsValid)
            {
